...
net-spec "$1".net 255 800 800 800 800 1 / ih0=2:0.5:0.5 bh0=5:0.5 h0h1=2:0.5 bh1=5:0.5 h1h2=2:0.5 bh2=5:0.5 h2h3=2:0.5 bh3=5:0.5 h3o=x2:0.5 bo=100
...
data-spec "$1".net 255 1 2 / "$1"_train.csv@1: . "$1"_test.csv@1: .
...
net-plt t h1h2h3h4h5h6h7h8h9 "$1".net > family_chain_"$1".txt
...
net-pred tmp "$1".net 7500: > family_result_"$1".txt
